...
const SocialAndPartySection = () => {
  return (
    <section className="flex flex-col gap-10 md:gap-x-16 lg:gap-20 ">
      ...
      <div className="my-12 flex items-center flex-col gap-10 md:gap-x-16 lg:gap-20">
        <div className="grid grid-cols-1 items-center md:[grid-template-columns:2fr_2.5fr] gap-8 md:gap-12 lg:gap-16">
          <div className="flex flex-col gap-4 md:gap-6">
          ...
          <AppImage src="/assets/images/main-section.jpg" direction="revert" />
        </div>
      </div>
    </section>
  );
