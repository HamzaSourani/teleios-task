...
import EventCard from "@/components/items/cards/event";
const EVENTS = [
  {
    imgSrc: "/assets/images/event.png",
    title: "chinese gp virtual gp",
...
const OurEventsCarousel = () => {
  const { breakpoint } = useBreakpoint(BREAKPOINTS);
  return (
    <section>
      <CarouselContainer title="our events">
        <Carousel opts={{ loop: breakpoint === "xs" }}>
          <div className="m-auto max-w-screen-3xl px-10  md:px-20 lg:px-36 xl:px-56 2xl:px-80">
            <div className="mb-4  flex flex-col items-center justify-between gap-2 md:mb-10  md:flex-row lg:mb-12">
              <p className="section-header">upcoming events</p>
              <div>
                <CarouselPrevious />
                <CarouselNext />
              </div>
...
export default OurEventsCarousel;
